    ...
    <div id="page">
        ...
        <div id="main">
            ...
            <div id="content">
                ...
                <div class="post">
                    <h2>JSON</h2>
                    <p class="postmeta">Posted in <a href="json.php">Web Service</a> | March 26, 2017 | <a href="#">0 comments</a></p>
                    <div class="entry">
                        <p>Langkah - langkah membuat program webservice dengan JSON </br> 1. Membuat Database = 'akademik' dengan nama Tabel Mahasiswa dengan struktur tabel nim, nama, alamat dan progdi. 
                        </p>
                        <a href = "images/jsondb.png"> <img src="images/jsondb.png" height="100%" width="100%"> </a>
                        <p>2. Tulis script program JSON seperti yang ada pada contoh gambar dibawah ini 
                        </p>
                        <a href = "images/json1.png"><img src="images/json1.png" height="100%" width="100%"></a>
                        <p>3. Contoh hasil program JSON yang sudah jadi
                        </p>
                        <a href = "images/json2.png"><img src="images/json2.png" height="100%" width="100%"></a>
                    </div>
                </div>
            </div><!-- content -->            
