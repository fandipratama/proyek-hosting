    ...
    <div id="page">
        ...
        <div id="main">
            ...
            <div id="content">
                ...
                <div class="post">
                    <h2>XML</h2>
                    <p class="postmeta">Posted in <a href="xml.php">Web Service</a> | March 26, 2017 | <a href="#">0 comments</a></p>
                    <div class="entry">
                        <p>Langkah - langkah membuat program webservice dengan XML </br> 1. Membuat Database = 'akademik' dengan nama Tabel Mahasiswa dengan struktur tabel nim, nama, alamat dan progdi. 
                        </p>
                        <a href = "images/xmldb.png"> <img src="images/xmldb.png" height="100%" width="100%"></a>
                        <p>2. Tulis script program xml seperti yang ada pada contoh gambar dibawah ini 
                        </p>
                        <a href = "images/xml1.png"><img src="images/xml1.png" height="100%" width="100%"> </a>
                        <p>3. Contoh hasil program xml yang sudah jadi
                        </p>
                        <a href = "images/xml2.png"><img src="images/xml2.png" height="100%" width="100%"> </a>
                    </div>
                </div>				              
            </div><!-- content -->            
